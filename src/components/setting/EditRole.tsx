                ...
                <Row>
                    <Col span={8}>
                        <Form.Item label={<span style={{color:'white'}}>Tên vai trò:</span>}>
                            <Input style={{ backgroundColor:'rgba(51, 51, 77, 1)', border: '1px solid rgba(114, 114, 136, 1)', color: 'white' }} defaultValue={'Kế toán'}/>
                        </Form.Item>
                        <Form.Item label={<span style={{color:'white'}}>Số điện thoại:</span>}>
                            <TextArea autoSize={{ minRows: 4, maxRows: 8 }} style={{ backgroundColor:'rgba(51, 51, 77, 1)', border: '1px solid rgba(114, 114, 136, 1)', color: 'white' }} defaultValue={'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua'}/>
                        </Form.Item>
